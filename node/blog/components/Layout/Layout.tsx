...
const Layout = ({ children, home }: LayoutProps): JSX.Element => {
	const renderBlogLayout = () => {
		return (
			<>
				<Link href="/">
					<a>
						<Image priority src="images/profileOne.png" circle height={108} width={108} alt={name} />
					</a>
				</Link>
	...
	const renderHomeLayout = () => {
		return (
			<>
				<Image priority src="images/profileOne.png" circle height={144} width={144} alt={name} />
